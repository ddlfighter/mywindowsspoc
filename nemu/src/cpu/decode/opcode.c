...
instr_func opcode_entry[256] = {
    ...
    /* 0x04 - 0x07*/ add_i2rm_b, inv, push_es, inv,
    /* 0x08 - 0x0b*/ inv, inv, inv, inv,
    /* 0x0c - 0x0f*/ or_i2rm_b, inv, inv, opcode_2_byte,
    ...
    /* 0x78 - 0x7b*/ inv, inv, jnbe_short, inv,
    /* 0x7c - 0x7f*/ jl_short, inv, inv, inv,
    /* 0x80 - 0x83*/ group_1_b, group_1_v, nemu_trap, cmps_bv,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, inv, jmp_near,
    ...
    /* 0xe4 - 0xe7*/ inv, mov_i2a_b, inv, inv,
    /* 0xe8 - 0xeb*/ jmp_near, jmp_near, inv, inv,
    /* 0xec - 0xef*/ inv, inv, inv, OUT_a2,
    /* 0xf0 - 0xf3*/ inv, break_point, inv, rep_repe,
    /* 0xf4 - 0xf7*/ hlt, inv, group_3_b, group_3_v,
    /* 0xf8 - 0xfb*/ clc, inv, inv, inv,
    /* 0xfc - 0xff*/ cld, inv, inv, nop,
};
