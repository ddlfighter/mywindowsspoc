...
instr_func __ref_opcode_entry[256] = {
    ...
    /* 0x20 - 0x23*/ __ref_and_r2rm_b, and_r2rm_v, and_rm2r_b, inv,
    /* 0x24 - 0x27*/ inv, and_i2a_v, inv, sbb_rm2r_v,
    ...
    /* 0xcc - 0xcf*/ inv, __ref_int, inv, __ref_iret,
    ...
    /* 0xe8 - 0xeb*/ call_i_v, jmp_near, jmp_far_imm, jmp_short_,
