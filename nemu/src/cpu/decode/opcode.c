...
instr_func opcode_entry[256] = {
    ...
    /* 0x04 - 0x07*/ add_rm2r_v, inv, inv, inv,
    /* 0x08 - 0x0b*/ inv, inv, inv, inv,
    /* 0x0c - 0x0f*/ or_i2r_b, inv, inv, opcode_2_byte,
    /* 0x10 - 0x13*/ inv, inv, inv, inv,
    /* 0x14 - 0x17*/ add_i2r_b, inv, inv, inv,
    /* 0x18 - 0x1b*/ inv, inv, inv, inv,
    /* 0x1c - 0x1f*/ sbb_i2r_b, inv, inv, inv,
    ...
    /* 0x7c - 0x7f*/ jl_short_, inv, inv, inv,
    ...
    /* 0xe4 - 0xe7*/ inv, mov_i2a_bv, inv, inv,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_rm_v, inv, inv, inv, inv, inv};
